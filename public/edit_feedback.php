            ...
            <form method="post">
                <div class="mb-4">
                    ...
                    <input name="subject"
                        ...
                        id="subject" type="text" placeholder="Subject" value="<?php echo $row['subject']; ?>" required>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2" for="message">Message</label>
                    <textarea name="message"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="message" rows="4" placeholder="Message" required><?php echo $row['message']; ?></textarea>
                </div>
                ...
                <div class="mb-4" style="visibility: hidden;">
                    ...
                    <input name="email"
                        id="email" type="email" placeholder="Email" value="<?php echo $row['email']; ?>" required
                        readonly>
                </div>
