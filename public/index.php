  ...
  <body class="">
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
      ...
      <ul
        ...
        <li>
          <a class="text-sm text-gray-400 hover:text-gray-500" href="#donate">Donate</a>
        </li>
      ...
      <div>
        ...
        <div id="userDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
          ...
          <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="avatarButton">
            <li>
              <a href="#"
                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Donation
                History</a>
            </li>
            <li>
              <a href="#"
                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Feedback
                History</a>
            </li>
          </ul>
        </div>
