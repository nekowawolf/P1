...
<body>
  ...
  <div class="text-center">
    <h1 class="pt-40 mb-4 text-3xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl">
      <span class="bg-gradient-to-r from-indigo-600 from-10% via-sky-500 via-30% to-emerald-50 to-90% ...">
        Thanks For Donation
      </span>
      <span>&nbsp;</span>
    ...
    <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
      <a href="h_donate.php" class="text-blue-500 hover:underline">Check History</a>
    </p>
  </div>
